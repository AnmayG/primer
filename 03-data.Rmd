...
<!-- Add skimr() and skim() to chapter 2. Simple one time use on a tibble. Explain what it does. At end of chapter before Summary. DONE -->

<!-- Use janitor::clean_names() in chapter 3. Simple example with a file with variable names like `my var` and `1-var`.  Read this in without fixing. Show how to use backticks to refer to those variables. Point out that this is annoying. Fix with clean_names(). DONE -->

<!-- Change all the files used so that they always have one blank line at the bottom to make that warning go away. Get rid of "warn" argument. DONE -->

<!-- * Deal with this message we get when knitting the chapter: -->

<!-- Output created: /Users/davidkane/Desktop/projects/primer/junk/data.html -->
<!-- Warning message: -->
<!-- In readLines(file) : -->
<!--   incomplete final line found on '/var/folders/mk/lh99bg295msg8myvcf5yczkc0000gn/T//Rtmpghqre9/file19e544177c18' Goes with befinning and done. -->
...
In this section, we'll be going over the common file formats and how we can pull data from these files into R.
...
<!-- AG: This currently relies on the renamed version for the test_4.csv file in primer.tutorials, so it won't work or knit correctly until that goes through -->
...
<!-- These are CSS rules that allow you to draw a box around HTML elements. This helps to make them stand out from the rest of the primer and actually look like an output from a program. -->
