...
con <- dbConnect(RSQLite::SQLite(), "03-data/data/chinook.db")
```
...
```{r}
# The kable() function is not strictly necessary, it's just there to make the table look nice.
t1 <- head(tbl(con, "albums"))
kable(t1)
t2 <- head(tbl(con, "artists"))
kable(t2)
```
...
If you want to see the full relationship diagram of this database, look here: http://schemaspy.org/sample/diagrams/summary/relationships.real.large.png
