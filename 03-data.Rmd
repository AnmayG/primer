...
```{r}
# You can also get a csv file by using the URL of the file.
# This won't work for all file types though.
file_2 <- "https://raw.githubusercontent.com/PPBDS/primer.tutorials/master/inst/www/test_2.csv"
...
<!-- AG: The caption seemed to knit ok, but I'm not sure if I should use it in the actual book. -->
